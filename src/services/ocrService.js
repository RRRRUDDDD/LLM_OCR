...
function classifyRateLimitError(status, responseText) {
...
async function fetchWithSmartRetry(url, options, signal) {
...
export function queueOcrTask(imageId, file, apiConfig) {
...
export function queueOcrBatch(imageIds, files, apiConfig) {
